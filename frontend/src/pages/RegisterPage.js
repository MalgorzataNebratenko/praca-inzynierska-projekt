      ...
      <div className="center">
            <Form onSubmit={e => submitRegistration(e)}>
              ...
              <Form.Group className="mb-3" >
                ...
                >
                  <Dropdown.Toggle className="text-left btn btn-warning btn-rounded shadow" data-mdb-ripple-color="#ffffff"  style={{backgroundColor: '#f19c51', border: 'none',  width: '100%', marginBottom: '5%'}}  id="dropdown-flags" >
                    {toggleContents}
                  </Dropdown.Toggle>
