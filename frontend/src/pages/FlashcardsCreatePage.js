...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (flashcardsContRef.current) {
      flashcardsContRef.current.scrollTop = flashcardsContRef.current.scrollHeight;
    }
  }, [flashcards]);
  ...
  return (
    <div>
      ...
      <div className="container-md bg-dark bg-card center flex-column" style={{maxHeight: "70vh"}}>
